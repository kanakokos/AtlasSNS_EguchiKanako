...
return [
    ...
    */
    ...
    'lifetime' => env('SESSION_LIFETIME', 120), //Cookie（session）の有効期限（分）

    'expire_on_close' => false, //有効期限を「ブラウザを閉じるまで」に設定
    ...
    */
    ...
    'encrypt' => true, //「false=データの暗号化を無効にする設定」、「true=Cookieの暗号化」
    ...
    */
    ...
    'store' => env('SESSION_STORE', null), // （apc,memcashedに保存する場合）キャッシュストア
